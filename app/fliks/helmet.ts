// Full standalone HTML for Helmet Reveal
// Interactive 3D helmet reveal with cursor/finger tracking
...
<body>
  ...
  <script type="module">
    ...
    // Don't clear console in WebView
    // console.clear();
    ...
    class Blob {
      constructor(renderer){
        ...
        const handlePointerMove = (event) => {
          ...
          this.uniforms.pointer.value.x = ( clientX / window.innerWidth ) * 2 - 1;
          this.uniforms.pointer.value.y = - ( clientY / window.innerHeight ) * 2 + 1;
        };
