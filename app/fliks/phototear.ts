...
const getPhotoTearHTML = () => {
  return `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <title>Photo Tear</title>
  <style>
    html, body {
      width: 100%;
      min-height: 100%;
...
<body>
  ...
  <script>
    ...
    const images = [
    {
      texture: textureLoader.load('https://picsum.photos/600/800?random=1'),
      colors: [[192, 208, 220], [217, 190, 174]] },

    {
      texture: textureLoader.load('https://picsum.photos/600/800?random=2'),
    ...
    let mouseDown = false;
    const extraImages = [
    { file: 'https://picsum.photos/600/800?random=3', colors: [[208, 229, 224], [209, 209, 220]] },
    { file: 'https://picsum.photos/600/800?random=4', colors: [[191, 192, 184], [217, 200, 170]] },
    { file: 'https://picsum.photos/600/800?random=5', colors: [[217, 226, 233], [216, 220, 203]] },
    { file: 'https://picsum.photos/600/800?random=6', colors: [[206, 221, 226], [219, 213, 222]] },
    { file: 'https://picsum.photos/600/800?random=7', colors: [[199, 199, 210], [218, 203, 195]] }];

    const postInitTextureLoader = new THREE.TextureLoader();
    postInitTextureLoader.setCrossOrigin('anonymous');
...
export default getPhotoTearHTML();
