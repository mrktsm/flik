// Full standalone HTML for Simon Game
const getSimonHTML = () => {
  return `<!DOCTYPE html>
<html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Alfa+Slab+One|VT323|Oswald">
    <style>
