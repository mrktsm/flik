import rabbitModelBase64 from "./rabbit_model";

const getSkatingBunnyHTML = () => {
  const html = `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <title>Skating Bunny</title>
...
// Inject model data URL
const rabbitModelBase64 = "RABBIT_MODEL_BASE64_PLACEHOLDER";
const modelDataUrl = "data:model/gltf-binary;base64," + rabbitModelBase64;
...
class BufferSim {
  ...
  return html.replace('RABBIT_MODEL_BASE64_PLACEHOLDER', rabbitModelBase64);
};

export default getSkatingBunnyHTML();
