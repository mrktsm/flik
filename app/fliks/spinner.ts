// Full standalone HTML for Fidget Spinner 3.0
const getSpinnerHTML = () => {
  return `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <title>Fidget Spinner 3.0</title>
...
<body>
  <div class="everything">
    <div class="holder">
      <div class="spinner">
        <img src="https://www.freeiconspng.com/uploads/fidget-spinner-in-gray-images-15.png" alt="Fidget Spinner" onerror="this.onerror=null; this.style.display='none'; console.error('Failed to load spinner image');">
      </div>
