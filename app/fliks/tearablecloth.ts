// Full standalone HTML for Tearable Cloth simulation
export const getTearableClothHTML = () => {
  return `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<body>
  ...
  <script>
    ...
    console.log('Tearable Cloth script starting...');
  </script>
  ...
  <script>
    ...
    var Cloth = function () {
        ...
        var start_y = canvas.height / 2 - (cloth_height * spacing) / 2;
...
export default getTearableClothHTML();
